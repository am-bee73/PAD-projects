...
/**
 * Listen to data from client and transmits it to server. This is done on a separate thread as must be done asynchronously to
 * reading data from server and transmitting that data to the client.
 */
